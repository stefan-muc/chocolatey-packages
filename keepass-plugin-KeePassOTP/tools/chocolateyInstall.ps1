...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.6.3/KeePassOTP.plgx'
$checksum = 'bc1806cfa2f2d1e6582ead18f5833efa18dc7d94323b956cadcde34059df1c8e'
$checksumType = 'sha256'
try {
