...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.28.1/KeePassOTP.plgx'
$checksum = 'E6AD39631145EE486ABD60550445F461CAD08DD6CEA66B8DE85CF9F7482E93E8'
$checksumType = 'sha256'
try {
