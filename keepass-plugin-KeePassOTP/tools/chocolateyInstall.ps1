...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.11/KeePassOTP.plgx'
$checksum = '8ef272c8695d7cb215d94889d9640e9dbe16d7737dbdddd54f1310c50faf2f83'
$checksumType = 'sha256'
try {
