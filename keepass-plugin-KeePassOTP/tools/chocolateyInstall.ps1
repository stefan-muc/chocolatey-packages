...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.12/KeePassOTP.plgx'
$checksum = '3390ef4b10c0e36732e86f1a915b58233d3757e335ed7040ab87a0814b1d426d'
$checksumType = 'sha256'
try {
