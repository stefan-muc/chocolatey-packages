...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.18.2/KeePassOTP.plgx'
$checksum = '56BA94958F62FC9602238F5EBE2E3DD66E5C0B3CDF0BE70A368CC2A8A84DC7ED'
$checksumType = 'sha256'
try {
