...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.19.1/KeePassOTP.plgx'
$checksum = 'C8FED539DA08B6450BF09927340855C1223EB62D1E5686EB6D4661799D22EAF1'
$checksumType = 'sha256'
try {
