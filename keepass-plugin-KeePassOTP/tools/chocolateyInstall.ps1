...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.2.1/KeePassOTP.plgx'
$checksum = '1257eaa8a84559afd9c2a6ae08b68712fc33dc9c76067aeec6cc778c97d671d2'
$checksumType = 'sha256'
try {
