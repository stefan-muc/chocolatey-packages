...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.20.2/KeePassOTP.plgx'
$checksum = 'C98F921C1D9972377263D6718F23B770FAE7275BCDB67E0C9A38A9D21DF0A551'
$checksumType = 'sha256'
try {
