...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.16.1/KeePassOTP.plgx'
$checksum = '16EAC7F66CFD989CB9CC25B28A858CBFDE142EAE5FC733D2F5932181E9CE8BD0'
$checksumType = 'sha256'
try {
