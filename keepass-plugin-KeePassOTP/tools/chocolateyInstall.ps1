...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.1.1/KeePassOTP.plgx'
$checksum = '0186E3A5936DD702FC3B1B98B5A1048109B9ED2A2F97D8892E424F17F97150B9'
$checksumType = 'sha256'
try {
