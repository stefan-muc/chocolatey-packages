...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.30/KeePassOTP.plgx'
$checksum = 'C041BC73D8C31EC9313E68A03B3AE2E4A2FEB5FBFA38577F80AA444B2E92F5A9'
$checksumType = 'sha256'
try {
