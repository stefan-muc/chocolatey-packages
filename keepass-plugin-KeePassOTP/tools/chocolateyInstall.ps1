...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.27/KeePassOTP.plgx'
$checksum = 'F27CCFDF7B142724A42E9DF710AB95617559B767C70E2FEFF8AFFB9BBECA43D2'
$checksumType = 'sha256'
try {
