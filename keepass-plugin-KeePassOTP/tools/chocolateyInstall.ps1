...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.1/KeePassOTP.plgx'
$checksum = '07FC9A2C3ECC6AB2E630478D4C979973A6D2BD4696D27DBED34CB96030F50C26'
$checksumType = 'sha256'
try {
