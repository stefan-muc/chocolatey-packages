...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.25.2/KeePassOTP.plgx'
$checksum = 'FA2B71AA14A158FBC0553F8B7792F631A4F1ECC3FB75CCDDAA6D877D3B63CAE0'
$checksumType = 'sha256'
try {
