...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.0.1/KeePassOTP.plgx'
$checksum = 'DAF5A3652E97AF369B44E64B3B9BF24E87C8DA3B75160482620F8C61C7A2132F'
$checksumType = 'sha256'
try {
