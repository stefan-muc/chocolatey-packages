...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.1.2/KeePassOTP.plgx'
$checksum = 'B9A482C51875E9272DBB4716744FB12B6FE6729BEF20060DD80791EFD191F17E'
$checksumType = 'sha256'
try {
