...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.21/KeePassOTP.plgx'
$checksum = '1B0555323852781C76D9C2A5F41DAC1496688E466A74E809D88E5AEE6B5F68CF'
$checksumType = 'sha256'
try {
