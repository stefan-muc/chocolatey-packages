...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.29/KeePassOTP.plgx'
$checksum = '951F3561CEC5004CD68942696778B5DE641A8EFA019D99CCE59974ED53FDDD91'
$checksumType = 'sha256'
try {
