...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.18/KeePassOTP.plgx'
$checksum = 'EE26DC36F6C5ED324F828428DADA4CE676A5BC2627BF1A0C363E0305F174A4D7'
$checksumType = 'sha256'
try {
