...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.3.1/KeePassOTP.plgx'
$checksum = 'a356bd45f52e8d2a86180aafabeea9a04eb81f7670b9df08e6d46114fa339286'
$checksumType = 'sha256'
try {
