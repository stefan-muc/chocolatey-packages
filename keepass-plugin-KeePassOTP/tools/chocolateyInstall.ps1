...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v0.20/KeePassOTP.plgx'
$checksum = '6B3BC5347D7D9C4E8CCE5E4D1966B1138A81E671839800C45BE4AD6DED9ECA41'
$checksumType = 'sha256'
try {
