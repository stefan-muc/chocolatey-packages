...
$url = 'https://github.com/Rookiestyle/KeePassOTP/releases/download/v1.6.1/KeePassOTP.plgx'
$checksum = 'f04996515c48b13c0d7e97f4391ae865f6e74c0ab87bd4aa38cbff00de4896bf'
$checksumType = 'sha256'
try {
